...
class TokenClaims(BaseModel):
    ...
    aud: Union[str, List[str]]      # Audience(s), MUST include your API's identifier
    ...
    roles: Optional[List[str]] = None   # IdP-specific claim (sometimes "roles", "groups", etc.)

    # ---- Allow custom claims ----
    extra: Dict[str, Any] = {}

def verify_jwt_token(token: str, jwks_client: jwt.PyJWKClient, client_id: str, signing_algos: str) -> TokenClaims:
    try:
