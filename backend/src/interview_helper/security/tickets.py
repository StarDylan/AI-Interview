...
class TicketStore:
    ...
    def generate_ticket(self, user_id: str, client_ip: str) -> Ticket:
    ...
    def validate_ticket(self, ticket_id: str, client_ip: str) -> Optional[Ticket]:
        """
    ...
    def get_active_tickets_count(self) -> int:
        ...
        self._cleanup_expired()
        return len([t for t in self._tickets.values() if t.is_valid()])
